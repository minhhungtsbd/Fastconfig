...
set commit_id_local=5b75c3bcaa3f1af6513b8c22d508c2a79a0dd992
...
powershell -NoProfile -ExecutionPolicy Bypass -Command "$commit='%commit_id_remote%'; $content = Get-Content '%UpdateFile%'; $replacement = 'set commit_id_local=5b75c3bcaa3f1af6513b8c22d508c2a79a0dd992
